...
obj-m += set_contention_window.o unlock.o flip_quiet_coll_bit.o interrupt_test_node1.o interrupt_test_node2.o gpio-irq-latency-test.o kernel_timing_test.o
